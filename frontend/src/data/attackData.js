...
export const initialHistoryData = [
    { id: 'EV-9901', date: '2026-03-29 18:00:13', type: 'BRUTE FORCE (PORT:554)', attack: 'BRUTE FORCE (PORT:554)', attack_type: 'BRUTE FORCE (PORT:554)', ip: '185.22.154.66', src_ip: '185.22.154.66', port: '554', proto: 'TCP/RTSP', loc: 'Moscow, RU', status: 'BLOCKED', threat: '92%', severity: '92%', severityScore: 92, coords: { lat: 55.7558, lng: 37.6173 }, connection_count: 342, success_count: 12, failed_count: 78, unique_passwords: 89, command_count: 45, suspicious_commands: 12, eventTimeline: [
    ...
    { id: 'EV-8842', date: '2026-03-29 20:15:44', type: 'DICTIONARY ATTACK (PORT:80)', attack: 'DICTIONARY ATTACK (PORT:80)', attack_type: 'DICTIONARY ATTACK (PORT:80)', ip: '45.12.33.102', src_ip: '45.12.33.102', port: '80', proto: 'HTTP', loc: 'Beijing, CN', status: 'MITIGATED', threat: '75%', severity: '75%', severityScore: 75, coords: { lat: 39.9042, lng: 116.4074 }, connection_count: 215, success_count: 8, failed_count: 54, unique_passwords: 67, command_count: 28, suspicious_commands: 7, eventTimeline: [
    ...
    { id: 'EV-7721', date: '2026-03-29 21:05:02', type: 'SSH TUNNEL EXPLOIT', attack: 'SSH TUNNEL EXPLOIT', attack_type: 'SSH TUNNEL EXPLOIT', ip: '103.44.201.12', src_ip: '103.44.201.12', port: '2222', proto: 'TCP/SSH', loc: 'Seoul, KR', status: 'DROPPED', threat: '98%', severity: '98%', severityScore: 98, coords: { lat: 37.5665, lng: 126.9780 }, connection_count: 567, success_count: 23, failed_count: 156, unique_passwords: 145, command_count: 92, suspicious_commands: 34, eventTimeline: [
    ...
    { id: 'EV-6610', date: '2026-03-29 21:44:10', type: 'MIRAI BOTNET SCAN', attack: 'MIRAI BOTNET SCAN', attack_type: 'MIRAI BOTNET SCAN', ip: '192.168.5.21', src_ip: '192.168.5.21', port: '23', proto: 'TELNET', loc: 'Tokyo, JP', status: 'LOGGED', threat: '85%', severity: '85%', severityScore: 85, coords: { lat: 35.6762, lng: 139.6503 }, connection_count: 428, success_count: 16, failed_count: 98, unique_passwords: 102, command_count: 67, suspicious_commands: 21, eventTimeline: [
